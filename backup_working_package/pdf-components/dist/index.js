...
var BoundingBox = ({
  ...
  const componentClassName = (0, import_classnames.default)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(React3.Fragment, { children: [
...
function initPdfWorker() {
  debugLog(`Initializing PDF.js worker (PDF.js version: ${import_react_pdf.pdfjs.version})`);
  if (import_react_pdf.pdfjs.version === "2.16.105") {
    debugLog("Detected version 2.16.105, using local worker file");
    const currentUrl = typeof window !== "undefined" ? window.location.origin : "";
    import_react_pdf.pdfjs.GlobalWorkerOptions.workerSrc = `${currentUrl}/pdf.worker.min.js`;
    debugLog(`Worker URL set to: ${import_react_pdf.pdfjs.GlobalWorkerOptions.workerSrc}`);
    return;
  }
  const majorVersion = parseInt(import_react_pdf.pdfjs.version.split(".")[0], 10);
  ...
  try {
    const workerUrl = `https://unpkg.com/pdfjs-dist@${import_react_pdf.pdfjs.version}/build/pdf.worker${fileExtension}`;
    import_react_pdf.pdfjs.GlobalWorkerOptions.workerSrc = workerUrl;
    ...
    try {
      const cdnjsUrl = `https://cdnjs.cloudflare.com/ajax/libs/pdf.js/${import_react_pdf.pdfjs.version}/build/pdf.worker${fileExtension}`;
      import_react_pdf.pdfjs.GlobalWorkerOptions.workerSrc = cdnjsUrl;
...
var { Document } = require("react-pdf");
initPdfWorker();
var DocumentWrapper = ({
  children,
  className,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className, ref: inputRef, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    Document,
    {
      file,
      options,
  ...
  const getUnmaskedArea = React8.useCallback(
    (boundingBoxes) => {
      ...
      return boxes.map((box, i) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { style: boxStyle, x: boxStyle.left, y: boxStyle.top, fill: "black" }, i);
      });
    },
    [pageDimensions, rotation, scale]
  );
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "pdf-reader__page-highlight-overlay", style: getPageStyle(), ...extraProps, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { className: "page-mask", style: getPageStyle(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("mask", { id: maskId, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { style: getPageStyle(), fill: "white" }),
      children && getUnmaskedArea(children)
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { style: getPageStyle(), fill: "white", opacity: "0.6", mask: `url(#${maskId})` })
  ] }) });
};
...
var ArrowFlagBase = ({
  ...
  const renderFlag = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "pdf-reader__arrow-flag-base__flag", style: flagPosition, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(IconFlag, { className: "pdf-reader__arrow-flag-base__flag-icon", headerPosition: position, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "text",
      {
        x: labelPosition,
        y: "54%",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: (0, import_classnames2.default)("pdf-reader__arrow-flag-base", className), ...extraProps, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "pdf-reader__arrow-flag-base__tail", style: tailPosition }),
    label && renderFlag()
  ] });
};
...
var IconFlag = ({
  ...
  if (headerPosition == POSITION.LEFT) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("svg", { viewBox: "0 0 62 22", className, children: [
...
var ArrowFlag = ({
  ...
  const renderArrowFlagBase = (boxes, position, showLabel) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ArrowFlagBase, { ...props });
  };
  const hasLeftFlag = leftBoundingBoxes.length > 0;
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: (0, import_classnames3.default)("pdf-reader__arrow-flag", className), ...extraProps, children: [
...
var OutlineItem = ({ items, onClick }) => {
  ...
  function renderItem(item) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "li",
      {
        className: (0, import_classnames4.default)("reader__outline-item", {
          "reader__outline-item--target-visible": isOutlineTargetVisible(item.dest)
        }),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("a", { href: "#", onClick: clickHandler, "data-test-id": "reader-outline-item", children: item.title }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(OutlineItem, { items: item.items, onClick })
        ]
      },
      item.dest?.toString() || item.title
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("ul", { className: "reader__outline-items", children: items.map((item) => renderItem(item)) });
};
...
var Outline = ({ ...extraProps }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "reader__outline", ...extraProps, children: !!outline && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(OutlineItem, { items: outline, onClick: clickHandler }) });
};
...
var Overlay = ({ children, ...extraProps }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "pdf-reader__overlay", style: getOverlayStyle(), ...extraProps, children });
};
...
var PageNumberControl = ({ className }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: (0, import_classnames5.default)("pdf-reader__page-number-control", className), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "pdf-reader__page-number-control__separator ", children: "/" }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { "aria-label": "Total Pages", className: "pdf-reader__page-number-control__total-pages", children: numPages })
  ] });
};
...
var PageWrapper = ({
  ...
  if (!pageDimensions?.height || !pageDimensions?.width) {
    if (isLoading && loading) {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: typeof loading === "function" ? loading() : loading });
    }
    if (!isLoading && errorMessage && error) {
      const err = new Error(errorMessage);
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: typeof error === "function" ? error({ error: err }) : error });
    }
    if (!isLoading && !errorMessage && noData) {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: typeof noData === "function" ? noData() : noData });
    }
    return null;
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
    "div",
    {
      ...
      children: [
        children,
        isBuildingPageImage && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "div",
          {
            className: (0, import_classnames6.default)("pdf-reader__page", {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "pdf-reader__page__outline-targets", children: outlineTargets.map(({ dest, leftPx, topPx }) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "span",
          {
...
var SidePanel = ({
  ...
  const renderCloseButton = () => {
    if (typeof closeButton === "boolean") {
      return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { className: "pdf-reader__side-panel-close-button", onClick: onClose, children: "x" });
    }
    return closeButton;
  };
  const renderDragHandle = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
      "div",
      {
        className: (0, import_classnames7.default)("pdf-reader__resize-zone", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "pdf-reader__drag-handle__inner" })
            }
          )
        ]
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        header && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h2", { className: "pdf-reader__side-panel-title", children: header }),
        content && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "pdf-reader__side-panel-content", children: content }),
        footer && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "pdf-reader__side-panel-footer", children: footer }),
        children,
        isOverlayVisible && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "pdf-reader__side-panel-overlay" })
      ]
    }
  );
};
...
var Thumbnail = ({ pageNumber }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    "a",
    {
      ...
      children: !!objectURL && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("img", { className: "pdf-reader__thumbnail-image", src: objectURL })
    }
  );
};
...
var ThumbnailList = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "pdf-reader__thumbnail-list-wrapper", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("ul", { className: "pdf-reader__thumbnail-list", children: Array.from({ length: numPages }).map((_, pageIndex) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("li", { className: "pdf-reader__thumbnail-list__item", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Thumbnail, { pageNumber: pageIndex + 1 }) }, pageIndex + 1)) }) });
};
...
var ContextProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(DocumentContext.Provider, { value: documentProps, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(TransformContext.Provider, { value: transformProps, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(UiContext.Provider, { value: uiProps, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ScrollContext.Provider, { value: scrollProps, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(PageRenderContext.Provider, { value: pageRenderProps, children }) }) }) }) });
};
